...
function isPageUnlocked(path) {
  return isRouteUnlocked(path)
}
        ...
        <nav class="p-4">
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <div
                v-else
                class="cursor-not-allowed rounded-2xl border border-white/5 bg-white/[0.015] px-4 py-3 opacity-45"
              >
                <div class="flex items-center gap-4">
                  <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-zinc-900 text-sm font-semibold text-zinc-500">
                    {{ page.badge }}
                  </div>

                  <div class="min-w-0 flex-1">
                    <p class="truncate text-sm font-semibold text-zinc-400">
                      {{ page.title }}
                    </p>
                  ...
                  <span class="rounded-full border border-white/8 bg-black/30 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-zinc-500">
                    Bloqueado
                  </span>
                </div>
              </div>
          ...
          <div class="mt-6 border-t border-white/5 pt-6">
            <button
              v-if="isPageUnlocked('/certificado')"
              type="button"
            ...
            <div
              v-else
              class="cursor-not-allowed rounded-3xl border border-white/5 bg-white/[0.015] px-5 py-5 opacity-45"
            >
              <div class="flex items-center gap-4">
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <p class="mt-1 text-sm leading-6 text-zinc-600">
                    Disponible cuando habilites el cierre del curso.
                  </p>
                </div>
              </div>
            </div>
